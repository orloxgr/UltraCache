...
Current version: **2.57.164**

2.57.164 keeps the External Cache Flush Varnish control visible when Varnish is detected/configured, while leaving purge behavior unchanged.
