...
Current version: **2.57.134**

2.57.134 stops frontend/on-demand media generation from leaving pending AVIF/WebP/Both queue rows, retires old partial on-demand queue rows, and keeps the automatic cron media hook limited to tiny upload-background batches. Explicit admin UI bulk and WP-CLI media conversion remain unrestricted.
