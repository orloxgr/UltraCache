...
trait Ultra_Cache_WP_ESI_Lifecycle_Trait
{
    /**
     ...
     */
    public static function purge_public_esi_fragment($fragment_id, array $context = array())
    {
        ...
        $url = function_exists('ultracache_get_esi_fragment_url')
            ? ultracache_get_esi_fragment_url((string) $definition['id'], $normalized_context)
