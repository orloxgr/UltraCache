        ...
        return array(
            ...
            'cssBundle'                     => array(
                ...
                'leftoverCssBundle'          => array(
                    ...
                    'runCount'              => isset($leftover_css_bundle['run_count']) ? (int) $leftover_css_bundle['run_count'] : 0,
                    ...
                    'bundleUrls'            => isset($leftover_css_bundle['bundle_urls']) && is_array($leftover_css_bundle['bundle_urls']) ? array_slice(array_values(array_map('strval', $leftover_css_bundle['bundle_urls'])), 0, 12) : array(),
