...
require_once ultracache_plugin_dir('includes/integrations/varnish/class-varnish-flush-scope-test-trait.php');
...
require_once ultracache_plugin_dir('includes/integrations/varnish/class-varnish-variant-test-trait.php');
require_once ultracache_plugin_dir('includes/integrations/varnish/class-varnish-conditional-revalidation-test-trait.php');
...
trait Ultra_Cache_WP_Varnish_Trait
{
    ...
    use Ultra_Cache_WP_Varnish_Flush_Scope_Test_Trait;
    use Ultra_Cache_WP_Varnish_Invalidation_Trait;
    use Ultra_Cache_WP_Varnish_Diagnostics_Trait;
    use Ultra_Cache_WP_Varnish_Variant_Test_Trait;
    use Ultra_Cache_WP_Varnish_Conditional_Revalidation_Test_Trait;
