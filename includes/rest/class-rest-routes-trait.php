...
trait Ultra_Cache_Rest_Routes_Trait
{
        ...
        return array(
            ...
            '/purge-all' => array(
                array(
                    ...
                    'permission_callback' => array($this, 'check_purge_all_permission'),
                ),
            ),
            ...
            '/lcp-observations' => array(
                array(
                    'methods'             => WP_REST_Server::READABLE,
                    'callback'            => array($this, 'lcp_observations_query'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => $this->get_lcp_observation_list_route_args(),
                ),
            ),
            '/lcp-observations/detail' => array(
                array(
                    'methods'             => WP_REST_Server::READABLE,
                    'callback'            => array($this, 'lcp_observation_detail'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array(
                        'pageHash' => array(
                            'type'              => 'string',
                            ...
                            'validate_callback' => static function ($value) {
                                return is_string($value) && 1 === preg_match('/^[a-fA-F0-9]{64}$/', $value);
                            },
                        ),
                    ),
                ),
            ),
            '/lcp-observations/manual-selector' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'lcp_observation_manual_selector'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array(
                        'pageHash' => array(
                            'type'              => 'string',
            ...
            '/lcp-observations/action' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'lcp_observation_action'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array(
                        'recordId' => array(
                            'type'              => 'integer',
                        ...
                        'action' => array(
                            ...
                            'enum'              => array('forget', 'relearn', 'refresh'),
                        ),
                    ),
                ),
            ),
            '/compression/capabilities' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'compression_capabilities'),
                    'permission_callback' => array($this, 'check_permission'),
                ),
            ),
            '/setup/wizard' => array(
            ...
            '/varnish/performance-snapshot' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'varnish_performance_snapshot'),
                    'permission_callback' => array($this, 'check_infrastructure_permission'),
                ),
            ),
                ...
                array(
                    ...
                    'args'                 => array(
                        'scope' => array(
                            'required' => false,
                            'default' => 'configured',
                            'sanitize_callback' => array($this, 'sanitize_varnish_flush_action_scope_param'),
                            'validate_callback' => array($this, 'validate_varnish_flush_action_scope_param'),
                        ),
                    ),
                ),
            ),
            ...
            '/litespeed/control' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'litespeed_control'),
                    'permission_callback' => array($this, 'check_litespeed_control_permission'),
                    'args'                => array(
                        'operation' => array(
                            'type'              => 'string',
                            'required'          => true,
                        ...
                        'requestId' => array(
                            ...
                            'sanitize_callback' => 'sanitize_text_field',
                            'validate_callback' => static function ($value) {
                                return is_string($value) && 1 === preg_match('/^[a-fA-F0-9-]{32,36}$/', $value);
                            },
                        ),
                        'expires' => array(
                            'type'              => 'integer',
            ...
            '/manual-warm/session' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'manual_warm_session'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array(
                        'action' => array(
                            'type'              => 'string',
                            'required'          => true,
                            'sanitize_callback' => 'sanitize_key',
                            'enum'              => array('begin', 'pause', 'cancel', 'end', 'status'),
                        ),
                        'token' => array(
                            'type'              => 'string',
                            'required'          => false,
            ...
            '/admin-theme' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'update_admin_theme'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array(
                        'theme' => array(
                            'type'              => 'string',
            ...
            '/media/background-worker' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_background_worker'),
                    'permission_callback' => array($this, 'check_media_background_worker_permission'),
                    'args'                => array(
                        'token' => array(
                            'type'              => 'string',
                            'required'          => true,
            ...
            '/media/conversion-test' => array(
                array(
                    'methods'             => WP_REST_Server::READABLE,
                    'callback'            => array($this, 'media_conversion_test_latest'),
                    'permission_callback' => array($this, 'check_permission'),
                ),
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_conversion_test_run'),
                    'permission_callback' => array($this, 'check_permission'),
                ),
            ),
            '/media/library-replacement/status' => array(
                array(
                    'methods'             => WP_REST_Server::READABLE,
                    'callback'            => array($this, 'media_library_replacement_status'),
                    'permission_callback' => array($this, 'check_permission'),
                ),
            ),
            '/media/library-replacement/session' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_library_replacement_session'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array(
                        'action' => array(
                            'required'          => true,
            ...
            '/media/library-replacement/restart' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_library_replacement_restart'),
                    'permission_callback' => array($this, 'check_permission'),
                ),
            ),
            '/media/library-replacement/recover' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_library_replacement_recover'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array(
                        'mode' => array(
                            'required'          => true,
                            'sanitize_callback' => static function ($value) {
                                ...
                                return in_array($value, array('continue', 'restart_database'), true) ? $value : 'continue';
                            },
                        ),
                    ),
                ),
            ),
            '/media/library-replacement/readiness' => array(
                array(
                    'methods'             => WP_REST_Server::READABLE,
                    'callback'            => array($this, 'media_library_replacement_readiness_status'),
                    'permission_callback' => array($this, 'check_permission'),
                ),
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_library_replacement_readiness_scan'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array(
                        'reset' => array(
                            'required'          => false,
            ...
            '/media/library-replacement/blockers' => array(
                array(
                    'methods'             => WP_REST_Server::READABLE,
                    'callback'            => array($this, 'media_library_replacement_blockers'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array(
                        'blockerCode' => array('required' => false, 'sanitize_callback' => 'sanitize_key'),
                ...
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_library_replacement_blocker_decisions'),
                    'permission_callback' => array($this, 'check_permission'),
                ),
            ),
            '/media/library-replacement/prepare' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_library_replacement_prepare'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array(
                        'reset' => array(
                            'required'          => false,
                        ...
                        'collisionPolicy' => array(
                            'required'          => false,
                            'sanitize_callback' => static function ($value) {
                                $value = sanitize_key((string) $value);
                                return in_array($value, array('block', 'overwrite'), true) ? $value : 'block';
                            },
                        ),
                        'limit' => array(
                            'required'          => false,
            ...
            '/media/library-replacement/do' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_library_replacement_do'),
                    'permission_callback' => array($this, 'check_media_replacement_do_permission'),
                    'args'                => array(
                        'sessionToken' => array(
                            'required'          => true,
                            'sanitize_callback' => 'sanitize_text_field',
            ...
            '/media/library-replacement/verify' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_library_replacement_verify'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array(
                        'sessionToken' => array(
                            'required'          => true,
            ...
            '/media/library-replacement/delete/confirm' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_library_replacement_delete_confirm'),
                    'permission_callback' => array($this, 'check_file_mutation_permission'),
                ),
            ),
            '/media/library-replacement/delete' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_library_replacement_delete'),
                    'permission_callback' => array($this, 'check_file_mutation_permission'),
                ),
            ),
            '/media/library-replacement/preview' => array(
                array(
                    'methods'             => WP_REST_Server::READABLE,
                    'callback'            => array($this, 'media_library_replacement_preview'),
                    'permission_callback' => array($this, 'check_permission'),
                ),
            ),
            '/media/library-replacement/replacements/preview' => array(
                array(
                    'methods'             => WP_REST_Server::READABLE,
                    'callback'            => array($this, 'media_library_replacement_database_preview'),
                    'permission_callback' => array($this, 'check_permission'),
                ),
            ),
            ...
            '/media/library-replacement/cleanup/preview' => array(
                array(
                    'methods'             => WP_REST_Server::READABLE,
                    'callback'            => array($this, 'media_library_replacement_cleanup_preview'),
                    'permission_callback' => array($this, 'check_permission'),
                ),
            ),
            ...
            '/media-queue/manual-session' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_manual_session_control'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array_merge(
                        $this->get_media_queue_common_args(),
                        array(
                            'session_action' => array(
                                ...
                                'validate_callback' => function ($value) {
                                    return in_array((string) $value, array('start', 'renew', 'stop'), true);
                                },
                            ),
                            'token' => array(
                                'type'              => 'string',
            ...
            '/media-queue/background-work' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_background_work_control'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => array_merge(
                        $this->get_media_queue_common_args(),
                        array(
            ...
            '/media-queue/requeue-completed-regeneration' => array(
                array(
                    'methods'             => WP_REST_Server::CREATABLE,
                    'callback'            => array($this, 'media_queue_requeue_completed_for_regeneration'),
                    'permission_callback' => array($this, 'check_permission'),
                    'args'                => $this->get_media_queue_common_args(),
                ),
            ),
    ...
    private function ultracache_font_scan_collect_html_icon_class_tokens($html, &$delay_icons)
    {
        $html = (string) $html;
        ...
        try {
            ...
            while ($processor->next_tag()) {
                $class_value = $this->ultracache_html_processor_attribute($processor, 'class');
                if ('' === $class_value) {
                    continue;
                }

                foreach (preg_split('/\s+/', $class_value) as $class_token) {
                    $class_token = trim((string) $class_token);
                    if ('' === $class_token || preg_match('/[^A-Za-z0-9_-]/', $class_token)) {
                        continue;
                    }

                    $normalized = strtolower($class_token);
                    // Plural icon-family class names are strong signals for icon fonts
                    // while avoiding generic wrapper classes such as elementor-icon.
                    if (false === strpos($normalized, 'icons') && false === strpos($normalized, 'iconfont')) {
                        continue;
                    }

                    $this->ultracache_font_scan_add_item($delay_icons, $class_token, 'frontpage class');
                }
            }
        } catch (\Throwable $e) {
            // Keep the server-side CSS scan available if malformed HTML blocks
            // class-token discovery.
        }
    }
    ...
    private function ultracache_font_scan_analyze_css($css, $source, &$delay_icons, &$never_delay)
    {
        ...
        foreach ((array) $font_face_scan['blocks'] as $block) {
            $block = (string) $block;
            $family = trim(trim(ultracache_font_css_extract_declaration($block, 'font-family')), " \t\r\n\0\x0B\"'");
    ...
    public function scan_frontpage_font_patterns($request = null)
    {
        ...
        $never_delay = array();
        $stylesheet_urls = array();
        $this->ultracache_font_scan_collect_html_icon_class_tokens($html, $delay_icons);
    ...
    private function current_user_can_manage_infrastructure()
    {
        return current_user_can('manage_options')
            && (current_user_can('activate_plugins') || current_user_can('manage_network_plugins'));
    }

    public function check_infrastructure_permission($request = null)
    {
        unset($request);

        return $this->current_user_can_manage_infrastructure();
    }

    private function resolve_requested_object_cache_backend($request = null)
    {
        $backend = $request instanceof WP_REST_Request
            ? sanitize_key((string) $request->get_param('backend'))
            : 'active';
        if (!in_array($backend, array('redis', 'apcu', 'sqlite', 'disk', 'active', 'selected'), true)) {
            $backend = 'active';
        }

        if ('selected' === $backend && class_exists('Ultra_Cache_Object_Cache_Manager') && method_exists('Ultra_Cache_Object_Cache_Manager', 'get_selected_backend')) {
            return sanitize_key((string) Ultra_Cache_Object_Cache_Manager::get_selected_backend());
        }
        if ('active' === $backend && class_exists('Ultra_Cache_Object_Cache_Manager') && method_exists('Ultra_Cache_Object_Cache_Manager', 'get_active_backend')) {
            return sanitize_key((string) Ultra_Cache_Object_Cache_Manager::get_active_backend());
        }
        if (in_array($backend, array('selected', 'active'), true)) {
            $settings = defined('ULTRACACHE_SETTINGS_KEY') ? get_option(ULTRACACHE_SETTINGS_KEY, array()) : array();
            $settings = is_array($settings) ? $settings : array();
            $selected = sanitize_key((string) ($settings['objectCacheBackend'] ?? 'redis'));
            return in_array($selected, array('redis', 'apcu', 'sqlite', 'disk'), true) ? $selected : 'redis';
        }

        return $backend;
    }

    public function check_object_cache_infrastructure_permission($request = null)
    {
        if (!current_user_can('manage_options')) {
            return false;
        }

        if ('redis' !== $this->resolve_requested_object_cache_backend($request)) {
            return true;
        }
    ...
    public function check_purge_all_permission($request = null)
    {
        unset($request);
        ...
        $settings = defined('ULTRACACHE_SETTINGS_KEY') ? get_option(ULTRACACHE_SETTINGS_KEY, array()) : array();
        $settings = is_array($settings) ? $settings : array();
        $varnish_runtime_enabled = class_exists('Ultra_Cache_WP')
            && method_exists('Ultra_Cache_WP', 'is_varnish_runtime_enabled')
            && Ultra_Cache_WP::is_varnish_runtime_enabled($settings);
        $includes_varnish = !empty($settings['flushAllIncludeVarnish'])
            && $varnish_runtime_enabled;

        return !$includes_varnish || $this->current_user_can_manage_infrastructure();
    }

    public function check_media_replacement_do_permission($request = null)
    {
        unset($request);
        ...
        if (!$media || !method_exists($media, 'get_media_library_replacement_do_status')) {
            return true;
        }

        $status = $media->get_media_library_replacement_do_status();
        if (empty($status['fileMutationPermissionRequired']) || !empty($status['fileMutationPermissionAllowed'])) {
            return true;
        }

        return new WP_Error(
            'ultracache_media_replacement_file_mutation_forbidden',
            __('Applying prepared Theme CSS replacements requires manage_options and activate_plugins permissions.', 'ultracache'),
            array('status' => 403)
        );
    }
    ...
    /**
     * Shared REST schema for server-side LCP observation filtering.
     *
     * @return array<string,array<string,mixed>>
     */
    private function get_lcp_observation_list_route_args()
    {
        return array(
            'search' => array(
                'type'              => 'string',
