        ...
        private function collect_js_delay_component_recommendations($html, array $settings = array())
        {
            ...
            $groups = array(
                ...
                array(
                    ...
                    'label' => 'Elementor load-order protections',
                    'confidence' => 'recommended',
                    'appendable' => true,
                    ...
                    'reason' => 'Elementor module/runtime scripts were detected. When Defer all JS is enabled, Elementor module providers and dependent common/admin-bar scripts should stay in the visible JS Delay / Defer Exclusions list unless the page has been verified clean.',
                ),
                array(
