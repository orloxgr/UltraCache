...
if (!class_exists('UCWP_CLI_Command') && defined('WP_CLI') && WP_CLI && class_exists('WP_CLI_Command')) {
    class UCWP_CLI_Command extends WP_CLI_Command
    {
        ...
        /**
         * Generate AVIF/WebP files using a resumable media conversion queue.
         *
         * ## OPTIONS
         *
         * [<action>]
         * : Optional action: status, rebuild, process, retry-failed, clear-completed. Default: process.
         *
         * [--ids=<ids>]
         * : Comma-separated attachment IDs to process directly.
         *
         * [--limit=<number>]
         * : Limit queued/processed attachments for this run.
         *
         * [--media-format=<media-format>]
         * : Media target format. One of best, avif, webp, both. Default: best.
         *
         * [--only-missing]
         * : Skip variants that already exist. Default for queue processing.
         *
         * [--time-budget=<seconds>]
         * : Soft processing budget for queue processing. Default: 20 seconds.
         *
         * [--format=<format>]
